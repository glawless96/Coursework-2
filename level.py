...
class Level:
    ...
    def start_level(self, screen):
        ...
        help_popup.set_message( self.start_game_help_text.helptext.title, font_size=40, border_group="group1", align="center", spacing=50, border_color=color.white, border_width=3, padding=20)
        for helptext in self.start_game_help_text.helptext.messages:
        ...
        help_popup.set_message(get_solution(self.operator, self.collected_numbers, self.target_number, all_possible_solutions), align="center", font_size=30, spacing = 50)
